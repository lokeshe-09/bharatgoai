...
const faqs = [
  ...
  },
  {
    ...
    answer: "99.9% SLA on Pro and above, with automatic failover. We're hosted on multiple availability zones in India (Mumbai and Bangalore). Last year our actual uptime was 99.97%. We publish real-time status at status.bharatgoai.com—nothing hidden."
  },
  {
